      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com"  target='_blank' className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://twitter.com" target='_blank' className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com"  target='_blank' className="hover:text-gray-400" aria-label="LinkedIn">
